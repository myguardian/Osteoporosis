...
def set_directory():
    ...
    main_path = os.getcwd()
    absolute_path = main_path + "/simplified_results"
    try:
...
def perform_deep_learning_control(path):
    ...
    try:
        ...
        #sns.pairplot(values[['bmdtest_tscore_fn', 'PatientAge', "PatientGender", 'bmdtest_weight', 'bmdtest_height', "shoulder", "wrist", "heartdisease", "diabetes", "arthritis", "respdisease", "smoke"]], diag_kind='kde').savefig("simplified_results/dropoutPairPlot.png")
    ...
    filename = "simplified_results/Control_RMSE_Results.txt"
    ...
    try:
        ...
        for name, model in models:   
            ...
            plt.legend()
            plt.grid(True)
            plt.savefig(f'simplified_results/{name}_loss.png')
            plt.clf()
            plt.close
            ...
            plt.ylim(lims)
            plt.plot(lims, lims)
            plt.savefig(f'simplified_results/{name}_Bin.png')
            plt.clf()
            plt.close
            ...
            plt.ylabel('Count')
            plt.savefig(f'simplified_results/{name}_error.png')
            plt.clf()
            plt.close
            ...
            #plt.savefig(f'simplified_results/{name}_ShapSummary.png', bbox_inches = "tight")
            #plt.clf()
            #plt.close
...
def perform_deep_learning_wrist(path):
    ...
    try:
        ...
        #sns.pairplot(values[['bmdtest_tscore_fn', 'PatientAge', "PatientGender", 'bmdtest_weight', 'bmdtest_height', "heartdisease", "diabetes", "arthritis", "respdisease", "smoke"]], diag_kind='kde').savefig("simplified_results/wristPairPlot.png")
    ...
    filename = "simplified_results/Wrist_RMSE_Results.txt"
    os.makedirs(os.path.dirname(filename), exist_ok=True)
    f = open(filename, 'w+')
...
def perform_deep_learning_shoulder(path):
    ...
    try:
        ...
        #sns.pairplot(values[['bmdtest_tscore_fn', 'PatientAge', "PatientGender", 'bmdtest_weight', 'bmdtest_height', "heartdisease", "diabetes", "arthritis", "respdisease", "smoke"]], diag_kind='kde').savefig("simplified_results/shoulderPairPlot.png")
    ...
    filename = "simplified_results/Shoulder_RMSE_Results.txt"
    os.makedirs(os.path.dirname(filename), exist_ok=True)
    f = open(filename, 'w+')
...
def perform_deep_learning_male(path):
    ...
    try:
        ...
        #sns.pairplot(values[['bmdtest_tscore_fn', 'PatientAge', 'bmdtest_weight', 'bmdtest_height', "shoulder", "wrist", "heartdisease", "diabetes", "arthritis", "respdisease", "smoke"]], diag_kind='kde').savefig("simplified_results/malePairPlot.png")
    ...
    filename = "simplified_results/Male_RMSE_Results.txt"
    os.makedirs(os.path.dirname(filename), exist_ok=True)
    f = open(filename, 'w+')
...
def perform_deep_learning_female(path):
    ...
    try:
        ...
        #sns.pairplot(values[['bmdtest_tscore_fn', 'PatientAge', 'bmdtest_weight', 'bmdtest_height', "shoulder", "wrist", "heartdisease", "diabetes", "arthritis", "respdisease", "smoke"]], diag_kind='kde').savefig("simplified_results/femalePairPlot.png")
    ...
    filename = "simplified_results/Female_RMSE_Results.txt"
    os.makedirs(os.path.dirname(filename), exist_ok=True)
    f = open(filename, 'w+')
...
def plot_permutation_importance(model, name, X, y):
    ...
    importance.to_csv(f'simplified_results/{name}_permutation_importance.csv')

    plt.barh(X.columns[sorted_importances_idx], result.importances_mean[sorted_importances_idx].T)
    plt.xlabel('Permutation Importance')
    plt.savefig(f'simplified_results/{name}_permutation_importance.png')
