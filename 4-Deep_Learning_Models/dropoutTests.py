...
def set_directory():
    ...
    main_path = os.getcwd()
    absolute_path = main_path + "/dropout_results"
    try:
...
def build_and_compile_model(norm):
  model = keras.Sequential([
      norm,
      layers.Dense(64, activation='relu', kernel_regularizer=l1_reg),
      layers.Dense(32, activation='relu', kernel_regularizer=l1_reg),
...
def perform_deep_learning_control(path):
    ...
    try:
        ...
        #sns.pairplot(values[['bmdtest_tscore_fn', 'PatientAge', "PatientGender", 'bmdtest_weight', 'bmdtest_height', "shoulder", "wrist", "heartdisease", "diabetes", "arthritis", "respdisease", "smoke"]], diag_kind='kde').savefig("dropout_results/dropoutPairPlot.png")
    ...
    filename = "dropout_results/Control_RMSE_Results.txt"
    ...
    try:
        ...
        for name, model in models:   
            ...
            plt.legend()
            plt.grid(True)
            plt.savefig(f'dropout_results/{name}_loss.png')
            plt.clf()
            plt.close
            ...
            plt.ylim(lims)
            plt.plot(lims, lims)
            plt.savefig(f'dropout_results/{name}_Bin.png')
            plt.clf()
            plt.close
            ...
            plt.ylabel('Count')
            plt.savefig(f'dropout_results/{name}_error.png')
            plt.clf()
            plt.close
            ...
            #plt.savefig(f'dropout_results/{name}_ShapSummary.png', bbox_inches = "tight")
            #plt.clf()
            #plt.close
...
def perform_deep_learning_wrist(path):
    ...
    try:
        ...
        #sns.pairplot(values[['bmdtest_tscore_fn', 'PatientAge', "PatientGender", 'bmdtest_weight', 'bmdtest_height', "heartdisease", "diabetes", "arthritis", "respdisease", "smoke"]], diag_kind='kde').savefig("dropout_results/wristPairPlot.png")
    ...
    filename = "dropout_results/Wrist_RMSE_Results.txt"
    os.makedirs(os.path.dirname(filename), exist_ok=True)
    f = open(filename, 'w+')
...
def perform_deep_learning_shoulder(path):
    ...
    try:
        ...
        #sns.pairplot(values[['bmdtest_tscore_fn', 'PatientAge', "PatientGender", 'bmdtest_weight', 'bmdtest_height', "heartdisease", "diabetes", "arthritis", "respdisease", "smoke"]], diag_kind='kde').savefig("dropout_results/shoulderPairPlot.png")
    ...
    filename = "dropout_results/Shoulder_RMSE_Results.txt"
    os.makedirs(os.path.dirname(filename), exist_ok=True)
    f = open(filename, 'w+')
...
def perform_deep_learning_male(path):
    ...
    try:
        ...
        #sns.pairplot(values[['bmdtest_tscore_fn', 'PatientAge', 'bmdtest_weight', 'bmdtest_height', "shoulder", "wrist", "heartdisease", "diabetes", "arthritis", "respdisease", "smoke"]], diag_kind='kde').savefig("dropout_results/malePairPlot.png")
    ...
    filename = "dropout_results/Male_RMSE_Results.txt"
    os.makedirs(os.path.dirname(filename), exist_ok=True)
    f = open(filename, 'w+')
...
def perform_deep_learning_female(path):
    ...
    try:
        ...
        #sns.pairplot(values[['bmdtest_tscore_fn', 'PatientAge', 'bmdtest_weight', 'bmdtest_height', "shoulder", "wrist", "heartdisease", "diabetes", "arthritis", "respdisease", "smoke"]], diag_kind='kde').savefig("dropout_results/femalePairPlot.png")
    ...
    filename = "dropout_results/Female_RMSE_Results.txt"
    os.makedirs(os.path.dirname(filename), exist_ok=True)
    f = open(filename, 'w+')
