...
def set_directory():
    ...
    main_path = os.getcwd()
    absolute_path = main_path + "/2Layer_results"
    try:
...
def perform_deep_learning_control(path):
    try:
        ...
        # Ensure that all columns have a numerical value and drop any empty rows
        a = ['bmdtest_tscore_fn', 'PatientAge', "PatientGender", 'bmdtest_weight', 'bmdtest_height', "shoulder",
             "wrist", "heartdisease", "diabetes", "arthritis", "respdisease", "smoke"]
        values = data[a]
        ...
        b = ['PatientAge', "PatientGender", 'bmdtest_weight', 'bmdtest_height', "shoulder", "wrist", "heartdisease",
             "diabetes", "arthritis", "respdisease", "smoke"]
        X = values[b]
        d = len(b)
        ...
        # sns.pairplot(values[['bmdtest_tscore_fn', 'PatientAge', "PatientGender", 'bmdtest_weight', 'bmdtest_height', "shoulder", "wrist", "heartdisease", "diabetes", "arthritis", "respdisease", "smoke"]], diag_kind='kde').savefig("2Layer_results/dropoutPairPlot.png")
    ...
    filename = "2Layer_results/Control_RMSE_Results.txt"
    ...
    try:
        ...
        for name, model in models:
            ...
            #
            # Plot the model difference between predictions and actual values
            #
            plt.figure()
            ...
            plt.legend()
            plt.grid(True)
            plt.savefig(f'2Layer_results/{name}_loss.png')
            plt.clf()
            ...
            plt.ylim(lims)
            plt.plot(lims, lims)
            plt.savefig(f'2Layer_results/{name}_Bin.png')
            plt.clf()
            ...
            plt.ylabel('Count')
            plt.savefig(f'2Layer_results/{name}_error.png')
            plt.clf()
...
def perform_deep_learning_wrist(path):
    try:
        ...
        # Ensure that all columns have a numerical value and drop any empty rows
        a = ['bmdtest_tscore_fn', 'PatientAge', "PatientGender", 'bmdtest_weight', 'bmdtest_height', "heartdisease",
             "diabetes", "arthritis", "respdisease", "smoke"]
        values = data[a]
        values = values.dropna()
        values = values.apply(pd.to_numeric, errors='coerce').dropna()
        ...
        # Create the Feature set
        b = ['PatientAge', "PatientGender", 'bmdtest_weight', 'bmdtest_height', "heartdisease", "diabetes", "arthritis",
             "respdisease", "smoke"]
        X = values[b]
        d = len(b)
        features = list(X.columns.values)
        ...
        # sns.pairplot(values[['bmdtest_tscore_fn', 'PatientAge', "PatientGender", 'bmdtest_weight', 'bmdtest_height', "heartdisease", "diabetes", "arthritis", "respdisease", "smoke"]], diag_kind='kde').savefig("2Layer_results/wristPairPlot.png")
    ...
    filename = "2Layer_results/Wrist_RMSE_Results.txt"
    os.makedirs(os.path.dirname(filename), exist_ok=True)
    f = open(filename, 'w+')
...
def perform_deep_learning_shoulder(path):
    try:
        ...
        # sns.pairplot(values[['bmdtest_tscore_fn', 'PatientAge', "PatientGender", 'bmdtest_weight', 'bmdtest_height', "heartdisease", "diabetes", "arthritis", "respdisease", "smoke"]], diag_kind='kde').savefig("2Layer_results/shoulderPairPlot.png")
    ...
    filename = "2Layer_results/Shoulder_RMSE_Results.txt"
    os.makedirs(os.path.dirname(filename), exist_ok=True)
    f = open(filename, 'w+')
...
def perform_deep_learning_male(path):
    try:
        ...
        a = ['bmdtest_tscore_fn', 'PatientAge', 'bmdtest_weight', 'bmdtest_height', "shoulder", "wrist", "heartdisease",
             "diabetes", "arthritis", "respdisease", "smoke"]
        values = data[a]
        values = values.dropna()
        values = values.apply(pd.to_numeric, errors='coerce').dropna()
        ...
        b = ['PatientAge', 'bmdtest_weight', 'bmdtest_height', "shoulder", "wrist", "heartdisease", "diabetes",
             "arthritis", "respdisease", "smoke"]
        X = values[b]
        d = len(b)
        features = list(X.columns.values)
        ...
        # sns.pairplot(values[['bmdtest_tscore_fn', 'PatientAge', 'bmdtest_weight', 'bmdtest_height', "shoulder", "wrist", "heartdisease", "diabetes", "arthritis", "respdisease", "smoke"]], diag_kind='kde').savefig("2Layer_results/malePairPlot.png")
    ...
    filename = "2Layer_results/Male_RMSE_Results.txt"
    os.makedirs(os.path.dirname(filename), exist_ok=True)
    f = open(filename, 'w+')
...
def perform_deep_learning_female(path):
    try:
        ...
        # sns.pairplot(values[['bmdtest_tscore_fn', 'PatientAge', 'bmdtest_weight', 'bmdtest_height', "shoulder", "wrist", "heartdisease", "diabetes", "arthritis", "respdisease", "smoke"]], diag_kind='kde').savefig("2Layer_results/femalePairPlot.png")
    ...
    filename = "2Layer_results/Female_RMSE_Results.txt"
    os.makedirs(os.path.dirname(filename), exist_ok=True)
    f = open(filename, 'w+')
