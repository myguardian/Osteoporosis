...
def set_directory():
    ...
    main_path = os.getcwd()
    absolute_path = main_path + "/L1_results"
    try:
...
def perform_deep_learning_control(path):
    try:
        ...
        # sns.pairplot(values[['bmdtest_tscore_fn', 'PatientAge', "PatientGender", 'bmdtest_weight', 'bmdtest_height', "shoulder", "wrist", "heartdisease", "diabetes", "arthritis", "respdisease", "smoke"]], diag_kind='kde').savefig("L1_results/dropoutPairPlot.png")
    ...
    filename = "L1_results/Control_RMSE_Results.txt"
    ...
    try:
        ...
        for name, model in models:
            ...
            plt.legend()
            plt.grid(True)
            plt.savefig(f'L1_results/{name}_loss.png')
            plt.clf()
            ...
            plt.ylim(lims)
            plt.plot(lims, lims)
            plt.savefig(f'L1_results/{name}_Bin.png')
            plt.clf()
...
def perform_deep_learning_wrist(path):
    try:
        ...
        # sns.pairplot(values[['bmdtest_tscore_fn', 'PatientAge', "PatientGender", 'bmdtest_weight', 'bmdtest_height', "heartdisease", "diabetes", "arthritis", "respdisease", "smoke"]], diag_kind='kde').savefig("L1_results/wristPairPlot.png")
    ...
    filename = "L1_results/Wrist_RMSE_Results.txt"
    os.makedirs(os.path.dirname(filename), exist_ok=True)
    f = open(filename, 'w+')
...
def perform_deep_learning_shoulder(path):
    try:
        ...
        # sns.pairplot(values[['bmdtest_tscore_fn', 'PatientAge', "PatientGender", 'bmdtest_weight', 'bmdtest_height', "heartdisease", "diabetes", "arthritis", "respdisease", "smoke"]], diag_kind='kde').savefig("L1_results/shoulderPairPlot.png")
    ...
    filename = "L1_results/Shoulder_RMSE_Results.txt"
    os.makedirs(os.path.dirname(filename), exist_ok=True)
    f = open(filename, 'w+')
...
def perform_deep_learning_male(path):
    try:
        ...
        # sns.pairplot(values[['bmdtest_tscore_fn', 'PatientAge', 'bmdtest_weight', 'bmdtest_height', "shoulder", "wrist", "heartdisease", "diabetes", "arthritis", "respdisease", "smoke"]], diag_kind='kde').savefig("L1_results/malePairPlot.png")
    ...
    filename = "L1_results/Male_RMSE_Results.txt"
    os.makedirs(os.path.dirname(filename), exist_ok=True)
    f = open(filename, 'w+')
...
def perform_deep_learning_female(path):
    try:
        ...
        # sns.pairplot(values[['bmdtest_tscore_fn', 'PatientAge', 'bmdtest_weight', 'bmdtest_height', "shoulder", "wrist", "heartdisease", "diabetes", "arthritis", "respdisease", "smoke"]], diag_kind='kde').savefig("L1_results/femalePairPlot.png")
    ...
    filename = "L1_results/Female_RMSE_Results.txt"
    os.makedirs(os.path.dirname(filename), exist_ok=True)
    f = open(filename, 'w+')
